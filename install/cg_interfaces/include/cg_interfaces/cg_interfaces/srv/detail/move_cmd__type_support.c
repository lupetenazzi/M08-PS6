...
static rosidl_typesupport_introspection_c__MessageMember cg_interfaces__srv__MoveCmd_Response__rosidl_typesupport_introspection_c__MoveCmd_Response_message_member_array[3] = {
  {
    "success",  // name
...
void cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__MoveCmd_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  cg_interfaces__srv__MoveCmd_Event__init(message_memory);
}

void cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__MoveCmd_Event_fini_function(void * message_memory)
{
  cg_interfaces__srv__MoveCmd_Event__fini(message_memory);
}

size_t cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__size_function__MoveCmd_Event__request(
  const void * untyped_member)
{
  const cg_interfaces__srv__MoveCmd_Request__Sequence * member =
    (const cg_interfaces__srv__MoveCmd_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__get_const_function__MoveCmd_Event__request(
  const void * untyped_member, size_t index)
{
  const cg_interfaces__srv__MoveCmd_Request__Sequence * member =
    (const cg_interfaces__srv__MoveCmd_Request__Sequence *)(untyped_member);
...
void * cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__get_function__MoveCmd_Event__request(
  void * untyped_member, size_t index)
{
  cg_interfaces__srv__MoveCmd_Request__Sequence * member =
    (cg_interfaces__srv__MoveCmd_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__fetch_function__MoveCmd_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const cg_interfaces__srv__MoveCmd_Request * item =
    ((const cg_interfaces__srv__MoveCmd_Request *)
    cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__get_const_function__MoveCmd_Event__request(untyped_member, index));
  cg_interfaces__srv__MoveCmd_Request * value =
    (cg_interfaces__srv__MoveCmd_Request *)(untyped_value);
  *value = *item;
}

void cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__assign_function__MoveCmd_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  cg_interfaces__srv__MoveCmd_Request * item =
    ((cg_interfaces__srv__MoveCmd_Request *)
    cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__get_function__MoveCmd_Event__request(untyped_member, index));
  const cg_interfaces__srv__MoveCmd_Request * value =
    (const cg_interfaces__srv__MoveCmd_Request *)(untyped_value);
  *item = *value;
}

bool cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__resize_function__MoveCmd_Event__request(
  void * untyped_member, size_t size)
{
  cg_interfaces__srv__MoveCmd_Request__Sequence * member =
    (cg_interfaces__srv__MoveCmd_Request__Sequence *)(untyped_member);
  cg_interfaces__srv__MoveCmd_Request__Sequence__fini(member);
  return cg_interfaces__srv__MoveCmd_Request__Sequence__init(member, size);
}

size_t cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__size_function__MoveCmd_Event__response(
  const void * untyped_member)
{
  const cg_interfaces__srv__MoveCmd_Response__Sequence * member =
    (const cg_interfaces__srv__MoveCmd_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__get_const_function__MoveCmd_Event__response(
  const void * untyped_member, size_t index)
{
  const cg_interfaces__srv__MoveCmd_Response__Sequence * member =
    (const cg_interfaces__srv__MoveCmd_Response__Sequence *)(untyped_member);
...
void * cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__get_function__MoveCmd_Event__response(
  void * untyped_member, size_t index)
{
  cg_interfaces__srv__MoveCmd_Response__Sequence * member =
    (cg_interfaces__srv__MoveCmd_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__fetch_function__MoveCmd_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const cg_interfaces__srv__MoveCmd_Response * item =
    ((const cg_interfaces__srv__MoveCmd_Response *)
    cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__get_const_function__MoveCmd_Event__response(untyped_member, index));
  cg_interfaces__srv__MoveCmd_Response * value =
    (cg_interfaces__srv__MoveCmd_Response *)(untyped_value);
  *value = *item;
}

void cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__assign_function__MoveCmd_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  cg_interfaces__srv__MoveCmd_Response * item =
    ((cg_interfaces__srv__MoveCmd_Response *)
    cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__get_function__MoveCmd_Event__response(untyped_member, index));
  const cg_interfaces__srv__MoveCmd_Response * value =
    (const cg_interfaces__srv__MoveCmd_Response *)(untyped_value);
  *item = *value;
}

bool cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__resize_function__MoveCmd_Event__response(
  void * untyped_member, size_t size)
{
  cg_interfaces__srv__MoveCmd_Response__Sequence * member =
    (cg_interfaces__srv__MoveCmd_Response__Sequence *)(untyped_member);
  cg_interfaces__srv__MoveCmd_Response__Sequence__fini(member);
  return cg_interfaces__srv__MoveCmd_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__MoveCmd_Event_message_member_array[3] = {
  {
    "info",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cg_interfaces__srv__MoveCmd_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(cg_interfaces__srv__MoveCmd_Event, request),  // bytes offset in struct
    NULL,  // default value
    cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__size_function__MoveCmd_Event__request,  // size() function pointer
    cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__get_const_function__MoveCmd_Event__request,  // get_const(index) function pointer
    cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__get_function__MoveCmd_Event__request,  // get(index) function pointer
    cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__fetch_function__MoveCmd_Event__request,  // fetch(index, &value) function pointer
    cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__assign_function__MoveCmd_Event__request,  // assign(index, value) function pointer
    cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__resize_function__MoveCmd_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(cg_interfaces__srv__MoveCmd_Event, response),  // bytes offset in struct
    NULL,  // default value
    cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__size_function__MoveCmd_Event__response,  // size() function pointer
    cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__get_const_function__MoveCmd_Event__response,  // get_const(index) function pointer
    cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__get_function__MoveCmd_Event__response,  // get(index) function pointer
    cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__fetch_function__MoveCmd_Event__response,  // fetch(index, &value) function pointer
    cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__assign_function__MoveCmd_Event__response,  // assign(index, value) function pointer
    cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__resize_function__MoveCmd_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__MoveCmd_Event_message_members = {
  "cg_interfaces__srv",  // message namespace
  "MoveCmd_Event",  // message name
  3,  // number of fields
  sizeof(cg_interfaces__srv__MoveCmd_Event),
  false,  // has_any_key_member_
  cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__MoveCmd_Event_message_member_array,  // message members
  cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__MoveCmd_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__MoveCmd_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__MoveCmd_Event_message_type_support_handle = {
  0,
  &cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__MoveCmd_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_cg_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cg_interfaces, srv, MoveCmd_Event)() {
  cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__MoveCmd_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__MoveCmd_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cg_interfaces, srv, MoveCmd_Request)();
  cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__MoveCmd_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cg_interfaces, srv, MoveCmd_Response)();
  if (!cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__MoveCmd_Event_message_type_support_handle.typesupport_identifier) {
    cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__MoveCmd_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__MoveCmd_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t cg_interfaces__srv__detail__move_cmd__rosidl_typesupport_introspection_c__MoveCmd_service_type_support_handle = {
  ...
  &cg_interfaces__srv__MoveCmd_Request__rosidl_typesupport_introspection_c__MoveCmd_Request_message_type_support_handle,
  &cg_interfaces__srv__MoveCmd_Response__rosidl_typesupport_introspection_c__MoveCmd_Response_message_type_support_handle,
  &cg_interfaces__srv__MoveCmd_Event__rosidl_typesupport_introspection_c__MoveCmd_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cg_interfaces, srv, MoveCmd_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cg_interfaces, srv, MoveCmd_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cg_interfaces, srv, MoveCmd_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_cg_interfaces
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cg_interfaces, srv, MoveCmd)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cg_interfaces, srv, MoveCmd_Event)()->data;
  }
