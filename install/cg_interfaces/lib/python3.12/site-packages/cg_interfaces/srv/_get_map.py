...
class GetMap_Event(metaclass=Metaclass_GetMap_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<cg_interfaces/GetMap_Request, 1>',
        'response': 'sequence<cg_interfaces/GetMap_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cg_interfaces', 'srv'], 'GetMap_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cg_interfaces', 'srv'], 'GetMap_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from cg_interfaces.srv import GetMap_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from cg_interfaces.srv import GetMap_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class GetMap(metaclass=Metaclass_GetMap):
    ...
    from cg_interfaces.srv._get_map import GetMap_Event as Event
